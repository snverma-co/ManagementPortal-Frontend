      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-md">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-semibold text-gray-800">{pendingTasks}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-md">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-semibold text-gray-800">{completedTasks}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-md sm:col-span-2 md:col-span-1">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-semibold text-gray-800">{totalDocuments}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-md mb-6">
            <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-4">Recent Tasks</h2>
            {tasks.length === 0 ? (
                ...
                <table className="min-w-full bg-white">
                  <thead>
                    <tr className="bg-gray-100 text-gray-600 uppercase text-xs md:text-sm leading-normal">
                      ...
                      <th className="py-3 px-4 md:px-6 text-left">Deadline</th>
                  ...
                  <tbody className="text-gray-600 text-xs md:text-sm">
                    {tasks.slice(0, 5).map((task) => (
                      <tr key={task._id} className="border-b border-gray-200 hover:bg-gray-50">
                        <td className="py-3 px-4 md:px-6 text-left">{task.title}</td>
