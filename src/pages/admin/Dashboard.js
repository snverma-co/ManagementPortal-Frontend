...
const AdminDashboard = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 border-l-4 border-blue-500">
          <div className="flex items-center">
            <div className="p-2 md:p-3 rounded-full bg-blue-100 text-blue-500 mr-4">
            ...
            <div>
              ...
              <p className="text-xl md:text-3xl font-semibold text-gray-800">{totalClients}</p>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 border-l-4 border-yellow-500">
          <div className="flex items-center">
            <div className="p-2 md:p-3 rounded-full bg-yellow-100 text-yellow-500 mr-4">
              <svg className="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-xl md:text-3xl font-semibold text-gray-800">{pendingTasks}</p>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 border-l-4 border-green-500">
          <div className="flex items-center">
            <div className="p-2 md:p-3 rounded-full bg-green-100 text-green-500 mr-4">
              <svg className="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-xl md:text-3xl font-semibold text-gray-800">{completedTasks}</p>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 border-l-4 border-purple-500">
          <div className="flex items-center">
            <div className="p-2 md:p-3 rounded-full bg-purple-100 text-purple-500 mr-4">
              <svg className="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-xl md:text-3xl font-semibold text-gray-800">{totalDocuments}</p>
            </div>
          </div>
          <div className="mt-4">
      ...
      {/* Task Status Chart and Recent Activity */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Task Status Overview</h2>
          <div className="flex flex-wrap items-center justify-around h-auto md:h-48">
            <div className="text-center m-2">
              <div className="inline-block w-16 h-16 md:w-24 md:h-24 rounded-full border-8 border-yellow-500 flex items-center justify-center">
                <span className="text-lg md:text-xl font-bold">{pendingTasks}</span>
              </div>
              <p className="mt-2 text-gray-600">Pending</p>
            </div>
            <div className="text-center m-2">
              <div className="inline-block w-16 h-16 md:w-24 md:h-24 rounded-full border-8 border-blue-500 flex items-center justify-center">
                <span className="text-lg md:text-xl font-bold">{inProgressTasks}</span>
              </div>
              <p className="mt-2 text-gray-600">In Progress</p>
            </div>
            <div className="text-center m-2">
              <div className="inline-block w-16 h-16 md:w-24 md:h-24 rounded-full border-8 border-green-500 flex items-center justify-center">
                <span className="text-lg md:text-xl font-bold">{completedTasks}</span>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="px-4 md:px-6 py-4 bg-indigo-50 border-b border-indigo-100">
            <h2 className="text-lg font-semibold text-gray-800">Recent Clients</h2>
          </div>
          <div className="divide-y divide-gray-200">
            {recentClients.length > 0 ? (
              recentClients.map(client => (
                <div key={client._id} className="px-4 md:px-6 py-4 hover:bg-gray-50">
                  <div className="flex items-center">
          ...
          <div className="divide-y divide-gray-200">
            {recentTasks.length > 0 ? (
              recentTasks.map(task => (
                <div key={task._id} className="px-4 md:px-6 py-4 hover:bg-gray-50">
                  <div className="flex items-center">
